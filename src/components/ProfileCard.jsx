...
const ProfileCard = ({ image, name, description }) => {
  return (
    <div className="max-w-sm rounded-lg overflow-hidden shadow-lg border border-gray-300/50 p-6">
      ...
      <div className="mt-10 text-center">
        <span className="inline-block bg-gray-200 hover:bg-gray-300 hover:cursor-pointer rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">
